...
function showPage(list, page) {
  ...
  <div class="student-details">
    <img src=${list[i].picture.medium}  alt="Profile Picture">
...
linkList.addEventListener("click", (e) => {
   ...
   if (buttonClicked) {
      ...
      // Call 'showPage' to display the list for the clicked page.
      // 'buttonClicked.innerHTML' gives us the page number from the button's text.
      showPage(studentsList, buttonClicked.innerHTML);
   }

});

// Call 'showPage' to display the first page (page 1) of the filtered students
